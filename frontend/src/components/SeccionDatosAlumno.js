    ...
    <div className="form-section">
      ...
      <div className="section-content">
        <div className="form-row">
          <label>
            CÓDIGO:
            <input type="text" name="CODIGO" value={formData.CODIGO} onChange={handleChange} placeholder="Código del alumno" maxLength={9} required />
            {errores.CODIGO && <span className="error-message">{errores.CODIGO}</span>}
          </label>
          <label>
            NOMBRE(S):
            <input type="text" name="NOMBRE" value={formData.NOMBRE} onChange={handleChange} placeholder="Nombre(s) del alumno" required />
        ...
        <div className="form-row">
          <label>
            APELLIDOS:
            <input type="text" name="APELLIDOS" value={formData.APELLIDOS} onChange={handleChange} placeholder="Apellidos del alumno" required />
        ...
        {formData.NIVEL_ACADEMICO === 'MAESTRÍA' && (
          <div className="form-row">
            <label className="select-label">
              MAESTRÍA:
              <select name="MAESTRIA" value={formData.MAESTRIA || ''} onChange={handleChange} required>
        ...
        <div className="form-row">
          <label>
            SEMESTRE:
            <input type="number" min="1" max="12" name="SEMESTRE" value={formData.SEMESTRE} onChange={handleChange} placeholder="Semestre actual" required />
            {errores.SEMESTRE && <span className="error-message">{errores.SEMESTRE}</span>}
          </label>
          <label>
            PROMEDIO:
            <input type="number" step="0.01" min="0" max="100" name="PROMEDIO" value={formData.PROMEDIO} onChange={handleChange} placeholder="Promedio general" required />
        ...
        <div className="form-row">
          ...
          <label>
            NÚMERO DE TELÉFONO:
            <input type="tel" name="TELEFONO" value={formData.TELEFONO} onChange={handleChange} placeholder="Número de teléfono" maxLength={10} required />
        ...
        <div className="form-row">
          <label>
            ...
            <input type="email" name="CORREO" value={formData.CORREO} onChange={handleChange} placeholder="Correo institucional" required />
            {errores.CORREO && <span className="error-message">{errores.CORREO}</span>}
          </label>
          <label>
            CONTACTO DE EMERGENCIA (TELÉFONO):
            <input type="tel" name="CONTACTO_EMERGENCIA" value={formData.CONTACTO_EMERGENCIA} onChange={handleChange} placeholder="Teléfono de emergencia" maxLength={10} required />
        ...
        {formData.CONTACTO_EMERGENCIA && (
          <div className="form-row">
            <label>
              ...
              <input type="text" name="NOMBRE_CONTACTO_EMERGENCIA" value={formData.NOMBRE_CONTACTO_EMERGENCIA} onChange={handleChange} placeholder="Nombre del contacto de emergencia" required />
        ...
        <div className="form-row">
          <label>
            ...
            <input type="text" name="NSS" value={formData.NSS} onChange={handleChange} placeholder="Número de Seguro Social" maxLength={11} required />
